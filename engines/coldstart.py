...
_BLACK_FAMILIES = [
    ...
    ["진하", "다크"],
    ["콜드브루"],
    # 자연어 확장 (2026-07-17, Leo 승인 — 어휘 밖 OOV 회복). '우유 없이'류 = 우유 무 = black.
    # bare '쓴'은 부정("안 쓴", "쓰지 않고")과 충돌해 제외 — 부정 처리는 LLM 경로 담당.
    ["우유 없", "우유 안", "우유안", "우유무", "우유 무"],
]
_SWEET_FAMILIES = [
    ["라떼", "플랫화이트", "플랫 화이트"],
    ["바닐라", "카라멜", "시럽"],
    ...
    ["오트"],
    ["연하"],
    # 자연어 확장 (2026-07-17, Leo 승인). 우유·단맛 존재 신호. 부정 안전(긍정 표현만).
    ["설탕"],
    ["생크림", "휘핑", "휘프"],
    ["부드럽", "부드러운"],
    ["달게", "달아", "단맛"],
    ["믹스"],
    ["우유 많", "우유 넣", "우유 팍", "우유 가득"],
]
