...
.hero {{
  ...
  background: linear-gradient(180deg, #0f0a20 0%, #080612 100%);
  overflow: hidden;
}}
.hero::before {{
  content: '';
...
.domain-card {{
  background: rgba(20,10,45,0.55); backdrop-filter: blur(20px) saturate(160%); -webkit-backdrop-filter: blur(20px) saturate(160%);
  border: 1px solid rgba(192,132,252,0.18);
  border-radius: 16px;
  padding: 14px;
  transition: border-color 0.2s;
}}
.domain-card:active {{ border-color: #d946ef33; }}
.d-head {{
  display: flex;
  align-items: center;
  gap: 6px;
...
.btn-primary {{
  ...
  box-shadow: 0 8px 24px rgba(217,70,239,0.4),  0 0 40px rgba(217,70,239,0.15);
}}
.btn-secondary {{
  display: block;
  width: 100%;
...
.btn-secondary:active {{ border-color: #d946ef; color: #d946ef; }}
